  ...
  <section id="about" className="section-padding">
    <div className="max-w-7xl mx-auto px-4 md:px-8">
      ...
      <motion.div initial={{ opacity: 0, y: 28 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="prose prose-slate dark:prose-invert max-w-none">
        <p>I'm <strong>Tagorepriyan S P</strong>, a passionate <strong>Full-Stack Developer</strong> focused on building fast, clean web applications and extracting insights from data.</p>
